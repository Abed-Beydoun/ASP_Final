...
import { isValidEmail, emailExists, getUsersFromLocalStorage, saveUsersToLocalStorage } from '../validationUtil';
  ...
  setInputErrors((prevInputErrors) => ({
    ...
    [fieldId]: true,
        ...
        const handleSubmit = (e) => {
          ...
          displayErrorMessage("id", "ID already exists. Please use a different ID.");
        }
...
<input
            ...
            />
               {errorMessages.id && <span className="error-message-reg">{errorMessages.id}</span>}
            ...
            />
               {errorMessages.firstName && <span className="error-message-reg">{errorMessages.firstName}</span>}
            <input
              type="text"
              name="lastName"
            ...
            />
          {errorMessages.lastName && <p className="error-message-reg">{errorMessages.lastName}</p>}
            <input
              type="email"
              name="email"
            ...
            />
             {errorMessages.email && <p className="error-message-reg">{errorMessages.email}</p>}
            <input
              type="password"
              name="password"
            ...
            />
            {errorMessages.password && <p className="error-message-reg">{errorMessages.password}</p>}
