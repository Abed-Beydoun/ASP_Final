...
import { isValidEmail, emailExists, isEmailUnique ,getUsersFromLocalStorage, saveUsersToLocalStorage } from '../validationUtil';
    ...
    const displayUsers = () => {
     ...
     const displayErrorMessage = (fieldId, message) => {
      ...
      const addOrUpdateUser = (event) => {
        ...
        const { id , firstName, lastName, email, password, editIndex } = formData;
        ...
        if (!id) {
            ...
            errors.push("ID must be at least 6 characters long.");
        ...
        if (editIndex !== '') {
            ...
            updatedUsers[editIndex] = { id , firstName, lastName, email, password };
        } else {
...
{/* <main> */}
    ...
    <div id="userFormContainer">
                ...
                <input
                        ...
                        {errorMessages.id && <div className="error-message-userForm">{errorMessages.id}</div>}
                        </div>
