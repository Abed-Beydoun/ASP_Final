  ...
  return (
    <div className="user-content">
      ...
      <div class="userPage">
        ...
        <div>
          {' '}
          <button className="addUserBtn" onClick={() => toggleUserForm()}>
            Add User
          </button>
        </div>
      </div>
      ...
      <div id="userFormContainer">
        <form id="userForm">
          <div className="form-group">
            ...
            {errorMessages.id && (
              <div className="error-message-userForm">{errorMessages.id}</div>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {errorMessages.firstName && (
              <div className="error-message-userForm">
                {errorMessages.firstName}
              </div>
            )}
          </div>
      ...
      <div id="deleteFormContainer">
        <form id="deleteForm">
          ...
          <div class="form-btns">
            <button type="button" class="confirm" onClick={deleteConfirmed}>
              Confirm
            </button>
            <button
              type="button"
